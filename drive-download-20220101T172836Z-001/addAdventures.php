...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO posts(owner_name, category, place_name, location, description, image) VALUES('$owner_name', 'Adventure', '$place_name', '$location', '$description', '$image');";
...
<head>
    ...
    <title>Add a Place to Enjoy</title>
</head>

<body background="./Images/Visit6.jpg">
    <div class="card">
        <div>
            <h2>Add a Place to Enjoy</h2>
        </div>
        <hr>
        <div class="form"></div>
        <form action="addAdventures.php" method="post" class="addPlace" enctype="multipart/form-data">
            <div class="field">
                <p>Your Name: 
