...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO posts(owner_name, category, place_name, location, description, image) VALUES('$owner_name', 'Food', '$place_name', '$location', '$description', '$image');";
...
<head>
    ...
    <title>Add a Place to Dine</title>
</head>

<body background="./Images/Dine.jpg">
    <div class="card">
        <div>
            <h2>Add a Place to Dine</h2>
        </div>
        <hr>
        <div class="form"></div>
        <form action="addFood.php" method="post" class="addPlace" enctype="multipart/form-data">
            <div class="field">
                <p>Your Name: 
